...
import {
  type Student, getStudentEnrollments, getStudentAttendance,
  getCourseById, getProgressForCourse
} from '../data/database';
...
export default function CourseProgressCard({ student, darkMode }: Props) {
