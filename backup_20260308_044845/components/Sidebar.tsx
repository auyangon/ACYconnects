...
import { type Student, getInitials } from '../data/database';
...
export default function Sidebar({ activeTab, setActiveTab, student, unreadCount, mobileOpen, setMobileOpen }: SidebarProps) {
