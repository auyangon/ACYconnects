...
export default function AttendanceCard({ student, darkMode }: Props) {
  const overall = getOverallAttendance(student.studentId);
  const records = getStudentAttendance(student.studentId);
