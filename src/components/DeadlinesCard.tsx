  ...
  return (
    <motion.div
      ...
      style={{ 
        ...
        boxShadow: '0 8px 30px rgba(0,20,10,0.06)' 
      }}
    >
        ...
        {deadlines.map((d, idx) => {
          ...
          return (
            <motion.div
              ...
              style={{ 
                background: d.urgent ? 'rgba(239,68,68,0.06)' : rowBg, 
                border: d.urgent ? '1px solid rgba(239,68,68,0.15)' : '1px solid transparent' 
              }}
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  {d.course && (
                    <span className="text-xs px-1.5 py-0.5 rounded-md font-medium" style={{ background: cfg.bg, color: cfg.color }}>
                      {d.course}
                    </span>
                  )}
                </div>
